...
class TextExtractor:
    ...
    def find_text_strings(self, rom_path: str):
        """Find all text strings in ROM with addresses"""
        # TODO: Implement text detection algorithms
        pass

    def extract_for_translation(self, rom_path: str):
        """Export text for translation projects"""
        # TODO: Create translation-friendly export
        pass
